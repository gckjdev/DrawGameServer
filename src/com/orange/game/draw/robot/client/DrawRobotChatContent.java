...
public class DrawRobotChatContent {
...
//	private final static int IDX_CONTNET_TYPE = 2;
	...
	DrawRobotChatContent() {
		
	}
	private static DrawRobotChatContent chatContent = new DrawRobotChatContent();
	
	public static DrawRobotChatContent getInstance() {
		return chatContent;
	}
