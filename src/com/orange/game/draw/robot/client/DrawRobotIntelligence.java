...
public class DrawRobotIntelligence {
		...
		private static final Logger logger = Logger.getLogger(DrawRobotIntelligence.class
			.getName());
		private DrawRobotChatContent chatContent = DrawRobotChatContent.getInstance();
...
//		private boolean hasSendCallWilds = false;
		...
		public DrawRobotIntelligence(int rule) {
...
//					setChatContent(TEXT,chatContent.getContent(DiceRobotChatContent.VoiceContent.YOU_ARE_FOOL));
					setChatContent(EXPRESSION, chatContent.getExpression(DrawRobotChatContent.Expression.PROUND));
					return canOpen;
			}
...
//				setChatContent(TEXT,chatContent.getContent(DiceRobotChatContent.VoiceContent.BELIEVE_IT));
				if ( RandomUtils.nextInt(2) == 0 )
					setChatContent(EXPRESSION, chatContent.getExpression(DrawRobotChatContent.Expression.SMILE));
				else 
					setChatContent(EXPRESSION, chatContent.getExpression(DrawRobotChatContent.Expression.PROUND));
			} 
...
//		}
		if ( RandomUtils.nextInt(3) == 1 ) {
			if ( safe == true ) {
				...
				setChatContent(EXPRESSION, chatContent.getExpression(DrawRobotChatContent.Expression.EMBARRASS));
			}
		}
	}
